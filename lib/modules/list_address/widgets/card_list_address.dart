...
class CardListAddress extends StatelessWidget {
  const CardListAddress({super.key, required this.addressList, });
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Expanded(
                    ...
                    child: SizedBox(
                      ...
                      child: CustomButton(
                        ...
                        onPressed: () {
                          UpdateAddressRoute(idAddress: addressList.id.toString()).push(context);
                        },
                        text: "Ubah Alamat",
                  ...
                  addressList.isSelected == false ? Expanded(
                    flex: 1,
                    child: SizedBox(
                      width: double.infinity,
                      child: PopupMenuButton(
                          ...
                          itemBuilder: (BuildContext buildContext) {
                            return [
                              const PopupMenuItem(
                                value: "/selectMain",
                                child: Text("Jadikan Alamat Utama & Pilih",
                                style: TextStyle(
                          ...
                          onSelected: (value) {
                            if(value == "/delete"){
                              try {
                                context.read<ListAddressCubit>().deleteAddress(addressList.id.toString());
                                ShowSnackbar.snackbar(context, "Berhasil hapus alamat", isSuccess: true);
                              } catch (e) {
                                ShowSnackbar.snackbar(context, e.toString(), isSuccess: false);
                              }
                            } else if(value == "/selectMain") {
                              try {
                                context.read<ListAddressCubit>().selectMainAddress(addressList.id.toString());
                                ShowSnackbar.snackbar(context, "Berhasil menjadikan alamat utama", isSuccess: true);
                              } catch (e) {
                                ShowSnackbar.snackbar(context, e.toString(), isSuccess: false);
                              }
                            }
