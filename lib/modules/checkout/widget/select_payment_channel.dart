          ...
          child: Column(
            ...
            children: [
              ...
              Flexible(
                child: ListView(
                  shrinkWrap: true,
                  children: state.channels.map((e) => 
                    Card(
                      color: e.user?.balance == 0 ? AppColors.redColor.withValues(alpha: 0.7) : AppColors.whiteColor,
                      ...
                      child: ListTile(
                        ...
                        onTap: e.user?.balance == 0 ? null : () {
                          context.read<CheckoutCubit>().setPaymentChannel(e);
                          Navigator.pop(context);
                          context.read<CheckoutCubit>().updateCheckout(checkout: state.checkout, e: e);
                        },
                        leading: ClipRRect(
                        ...
                        subtitle: Text(
                          e.paymentType == "APP"
                              ...
                              : e.paymentType
                                  ...
                                  "",
                          style: TextStyle(
                              fontSize: 14, color: e.user?.balance == 0 ? AppColors.whiteColor : Colors.grey),
                        ),
