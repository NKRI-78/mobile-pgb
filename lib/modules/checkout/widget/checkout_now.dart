        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
                              ...
                              children: [
                                Expanded(
                                  child: Row(
                                    children: [
                                      ImageCard(
                                          image: (state.checkoutNow?.data?.pictures?.isEmpty ??
                                          false)
                                          ? ""
                                          : state.checkoutNow?.data?.pictures?.first
                                          .link ??
                                          "",
                                          height: 80,
                                          radius: 10,
              ...
              Divider(color: AppColors.blackColor.withOpacity(0.2),height: 5,thickness: 1,),
              InkWell(
                ...
                onTap: () async {
                  if(context.mounted){
                    context.read<CheckoutCubit>().getCostItemV2(
                      context: context,
                      storeId: state.checkoutNow?.data?.store?.id.toString() ?? "",
                      weight: state.checkoutNow?.data?.weight.toString() ?? ""
                    );
                  }
                },
                child: Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                            flex: 12,
                            child: Text(
                             state.loadingCost ? "Loading..." :  state.shippings?[state.checkoutNow?.data?.store?.id.toString()] == null ? 
                             'PILIH PENGIRIMAN':  
