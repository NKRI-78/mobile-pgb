...
class _ModalBottomViewState extends State<ModalBottomView>
  ...
  void _runAddToCartAnimation() {
    ...
    final imagePosition =
        imageBox.localToGlobal(Offset.zero, ancestor: overlayBox);
    final cartPosition =
        cartBox.localToGlobal(Offset.zero, ancestor: overlayBox);
    ...
    controller.addStatusListener((status) {
      if (status == AnimationStatus.completed) {
        ...
        controller.dispose();
        try {
          context.read<DetailProductCubit>().assignQty(
              widget.data?.id.toString() ?? "",
              _counterInit.toString(),
              context);
        } catch (e) {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomButton(
                      onPressed:
                          loadingAnimation ? null : _runAddToCartAnimation,
