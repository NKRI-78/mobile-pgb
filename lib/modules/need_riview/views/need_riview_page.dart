...
import 'package:mobile_pgb/modules/need_riview/widgets/list_riview.dart';
          ...
          body: CustomScrollView(
            slivers: [
              ...
              SliverList(delegate: SliverChildListDelegate([
                ...
                : state.needRiviewModel.isEmpty? const EmptyPage(msg: "Belum ada produk yang harus dinilai")
                : Padding(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          ...
                          child: ListRiview(e: state.needRiviewModel[index])
                        );
                      },
                    ),
                ),
